 ...
 * Return:IT SHOULD RETURN A pointer to the newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buf;
...
/**
 * close_file - A FUN THAT Closes file descriptors.
...
/**
 * main - the f that Copies the contents of a file to another file.
